    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 6;
          return axios__WEBPACK_IMPORTED_MODULE_4__["default"].post("/api/v1/auth/update-cart", pizza);
        case 6:
          res = _context.sent;
          if (res.status === 201) {
        ...
        resendOtp.addEventListener("click", function (e) {
          ...
          axios__WEBPACK_IMPORTED_MODULE_4__["default"].get("/api/v1/auth/resend-otp").then(function (res) {
            if (res.status === 201) {
              ...
              (0,_notyfy__WEBPACK_IMPORTED_MODULE_0__["default"])().success("OTP successfully send");
            ...
            (0,_utils__WEBPACK_IMPORTED_MODULE_2__.addError)(document.querySelector(".errorDiv"), err.message);
            otpVerificationForm.querySelector("button[type='submit']").disabled = true;
          });
        });
      }
...
userAvatar && userAvatar.addEventListener("click", function (e) {
...
loginForm && loginForm.addEventListener("submit", function (e) {
  ...
  (0,_formValidator__WEBPACK_IMPORTED_MODULE_1__.formValidate)(loginForm, fields, function (data, errorEl) {
    axios__WEBPACK_IMPORTED_MODULE_4__["default"].post("/api/v1/auth/login", data).then(function (res) {
      if (res.status === 200) {
        (0,_notyfy__WEBPACK_IMPORTED_MODULE_0__["default"])().success("User Login successfully.");
        setTimeout(function () {
          location.replace("/");
        }, 1000);
      }
      ...
      // console.log(err);
      (0,_utils__WEBPACK_IMPORTED_MODULE_2__.addError)(errorEl, err.response.data.message);
